...
//    registry.category("views").add("delivery_schedule", DeliveryScheduleView);
    console.log('%c[add view registry] test_tasks.DeliverySchedule', 'background: green; color: white');
